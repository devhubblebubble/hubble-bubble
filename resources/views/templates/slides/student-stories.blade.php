<div class="swiper-slide bark_bg">
    <div id="page_stories" class="bottom_spacing">
        <div class="slide_header">
            <div class="header_flex">
                <div class="menu__trigger header_toggle_btn swiper_back">
        ...
        <div class="stories_content">
            ...
            <div class="swiper storiesSwiper">
                <div class="swiper-wrapper">
                    ...
                    <div id="animated_card" class="swiper-slide stories_item" data-slide-type="img">
